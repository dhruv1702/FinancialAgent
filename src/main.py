...
def main():
    ...
    st.write("""
        I am an intelligent financial agent. I will try to answer financial questions grounded in the 10K, 10Q reports of public companies. If the answer does not exist in the context, I will declare that it is not found in my SEC data.
    \n I am a working prototype so my knowledge base only covers ["AAPL", "MSFT", "GOOGL", "AMZN", "META"].
""")
